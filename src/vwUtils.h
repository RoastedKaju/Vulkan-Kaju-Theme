...
namespace vw::utils
{
    ...
    inline VkCommandBufferAllocateInfo cmdBufferAllocateInfo(VkCommandPool pool, uint32_t count = 1)
    {
    ...
    inline void transitionImage(VkCommandBuffer cmd, VkImage img, VkImageLayout currLayout, VkImageLayout newLayout)
    {
